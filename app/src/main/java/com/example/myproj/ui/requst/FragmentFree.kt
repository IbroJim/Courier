...
class FragmentFree : Fragment(), RequstAdapter.OnLanguageListenner {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view:View = inflater.inflate(R.layout.fragment_free,container, false)
   ...
   private fun setupRecyclerView(view:View){
    ...
    private fun createListData():MutableList<Request>{
        ...
        list.add(Request("ул. Маркулова дом 56","Garris", 1340))
        list.add(Request("ул. Филотова дом 13","CFC", 760))
        list.add(Request("ул. Карла Маркса дом 143","Mcdonalds", 1500))
        list.add(Request("ул. Мирашниченко дом 23","Garris", 800))
        list.add(Request("ул. Амет-хан Султана дом 15","Mr Donnat", 945))
